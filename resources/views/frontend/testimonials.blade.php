      ...
      <div class="row">
         <div class="col-lg-4 col-md-6">
            <div class="quote-item quote-border mt-5">
               ...
               <div class="quote-item-footer">
                  <img loading="lazy" class="testimonial-thumb" src="{{url('frontend/images/clients/testimonial1.png')}}" alt="testimonial">
         ...
         <div class="col-lg-4 col-md-6">
            <div class="quote-item quote-border mt-5">
               ...
               <div class="quote-item-footer">
                  <img loading="lazy" class="testimonial-thumb" src="{{url('frontend/images/clients/testimonial2.png')}}" alt="testimonial">
                  <div class="quote-item-info">
         ...
         <div class="col-lg-4 col-md-6">
            <div class="quote-item quote-border mt-5">
               ...
               <div class="quote-item-footer">
                  <img loading="lazy" class="testimonial-thumb" src="{{url('frontend/images/clients/testimonial3.png')}}" alt="testimonial">
                  <div class="quote-item-info">
